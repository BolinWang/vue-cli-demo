<template>
    <div>
        ...
        <ul class="tab">
            <li :class="{'active': !settlementStatus}" @click="changeTab(null)">
                <span>全部</span>
            </li>
            <li :class="{'active': settlementStatus == 1}" @click="changeTab(1)">
                <span>未结算</span>
            </li>
            <li :class="{'active': settlementStatus == 3}" @click="changeTab(3)">
                <span>已结算</span>
            </li>
            <li :class="{'active': settlementStatus == 4}" @click="changeTab(4)">
                <span>已退款</span>
            </li>
        </ul>
    </div>
